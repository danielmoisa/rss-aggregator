...
func (apiCfg *ApiConfig) GetPostsForUserHander(w http.ResponseWriter, r *http.Request, user database.User) {
	...
	if err != nil {
		utils.ResponseWithError(w, 400, fmt.Sprintf("Couldn't get posts: %v", err))
		return
	}

	utils.ResponseWithJSON(w, 200, posts)
}
